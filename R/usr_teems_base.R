...
#'
#' @param base_har Character of length 1, file name in working
...
#' base_config <- teems_base(base_har = gddat.har,
...
#'
#' base_config <- teems_base(base_har = path_to_har,
...
args_list["..."] <- NULL
args_list[["base_har"]] <- .check_input(file = base_har,
                                        valid_ext = "har",
                                        call = call)
