...
#'  accuracy, and error checks are carried out following a
#'  successful run.
#'
#'@param cmf_path Character length 1 (default is `NULL`), path to
#'  the cmf file generated by [`ems_deploy()`] or created via an
...
#'@param ... Under development. A named list of input files
#'  necessary for an "in-situ" model run. Names must correspond
#'  to "File" statements within the model Tablo file. Elements
#'  correspond to file paths where these files are found. No
#'  checks or modifications are conducted on input files used in
#'  this manner. This mode does not support partial provision of
...
#'}
#'
#'@return File path to a CMF file that may be used with
#'  [`ems_compose`].
#'
#'@export
